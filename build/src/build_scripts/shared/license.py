...
def activate(oras_push: bool) -> None:
    ...
    cache_hit = False
    if oras_push:
        cache_hit = restore(settings.cache_registry, "unity-license", "v1", license_directory)
    ...
    if oras_push and not cache_hit:
        save(settings.cache_registry, "unity-license", "v1", license_directory, ["Unity_lic.ulf"])
