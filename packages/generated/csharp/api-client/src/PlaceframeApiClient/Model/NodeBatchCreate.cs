...
namespace PlaceframeApiClient.Model
{
    ...
    public partial class NodeBatchCreate
    {
        ...
        public NodeBatchCreate(Guid id, double rotationZ, double positionY, double positionZ, double rotationX, double rotationY, double rotationW, double positionX, LinkType linkType, LabelType labelType)
        {
            this.Id = id;
