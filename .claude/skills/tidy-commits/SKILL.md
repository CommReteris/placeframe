...
4. **Write the commit-building script:**
   ...
   - Present the script to the user for review. They approve it once, then it runs via the wrapper.
...
6. **Run the wrapper** after user approval: `uv run tidy-commits-wrapper`. Then report the result.
