...
Record the structural understanding in `agent/research/unity-bee-cache-internals.md`. This is not just measurements — it's an explanation of how the system works, what we observed, and how it informs CI caching decisions. Update the ticket with a summary and link to the research file.
...
| `agent/research/unity-bee-cache-internals.md` | New — research findings on Bee build system |
| `agent/tickets/ci/t78-unity-ci-build-time-optimization.md` | Record findings, update status |
