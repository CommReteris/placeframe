...
Change the hardcoded path to: `process.env["BOARD_TICKETS_DIR"] ?? path.resolve(process.cwd(), "../../../agent/tickets")`. This lets tests point at a fixture directory without touching real ticket files.
