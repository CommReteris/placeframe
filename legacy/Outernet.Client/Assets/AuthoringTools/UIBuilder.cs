...
namespace Outernet.Client.AuthoringTools
{
    ...
    public static partial class UIBuilder
    {
        ...
        {
            var editableLabel = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.EditableLabel);
        ...
        {
            var result = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.Text);
            result.text = text;
        ...
        {
            var result = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.Button);
        ...
        {
            var window = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.Window);
        ...
        {
            var listElement = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.ListElement);
        ...
        {
            var inputField = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.InputField);
        ...
        {
            var inputRegion = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.InputRegion);
        ...
        {
            var view = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.Toggle).AsView<Toggle, ToggleView>();
            view.AddBinding(view.gameObject.DestroyOnRelease());
            return view;
        }
        ...
        {
            var dropdown = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.Dropdown);
        ...
        public static Foldout Foldout(ObservablePrimitive<string> label = null, params Component[] content)
            => SetupPropertyLabel(label, AuthoringToolsPrefabs.Foldout, content);
        ...
        public static PropertyLabel Header(ObservablePrimitive<string> label = null, params Component[] content)
            => SetupPropertyLabel(label, AuthoringToolsPrefabs.Header, content);
        ...
        public static PropertyLabel TightPropertyLabel(ObservablePrimitive<string> label, params Component[] content)
            => SetupPropertyLabel(label, AuthoringToolsPrefabs.TightPropertyLabel, content);
        ...
        public static PropertyLabel PropertyLabel(ObservablePrimitive<string> label, params Component[] content)
            => SetupPropertyLabel(label, AuthoringToolsPrefabs.AdaptivePropertyLabel, content);
        ...
        {
            var layout = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.HorizontalLayout);
        ...
        {
            var layout = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.VerticalLayout);
        ...
        {
            var scrollRect = UnityEngine.Object.Instantiate(AuthoringToolsPrefabs.ScrollRect);
